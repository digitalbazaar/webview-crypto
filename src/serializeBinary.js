...
var ArrayBufferSerializer = {
    ...
    toObject: function (ab) { return __awaiter(void 0, void 0, void 0, function () {
        var bytes, MAX_BUFFER_LENGTH, str, i;
        return __generator(this, function (_a) {
            bytes = new Int8Array(ab);
            MAX_BUFFER_LENGTH = 64 * 1024;
            if (bytes.length <= MAX_BUFFER_LENGTH)
                return [2 /*return*/, String.fromCharCode.apply(null, bytes)];
            str = "";
            // Fixes Maximum call stack size exceeded error which triggers when passing large buffers.
            for (i = 0; i < bytes.length; i += MAX_BUFFER_LENGTH)
                str += String.fromCharCode.apply(null, bytes.slice(i, i + MAX_BUFFER_LENGTH));
            return [2 /*return*/, str];
        });
    }); },
